...
class _EditDishPageState extends State<EditDishPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<EditDishBloc, EditDishState>(
                ...
                children: [
                  InputField(
                      ...
                      onChanged: (value) {
                        context
                            .read<EditDishBloc>()
                            .add(EditDishNameEvent(name: _nameController.text));
                      },
                  ...
                  InputField(
                      ...
                      validator: (value) => generiqueValidator(value, "Label"),
                      hint: "The label of the dish",
                      icon: Icons.label),
                  DropDownMenu(
                      dropdownItems: dropdownCategoryItems(),
                      onChanged: (value) {
                        context.read<EditDishBloc>().add(EditDishCategoryEvent(
                        ...
                        SizedBox(
                          ...
                          child: GestureDetector(
                            ...
                            child: CheckboxListTile(
                              ...
                              value:
                                  context.watch<EditDishBloc>().state.featured,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: InputField(
                              ...
                              onChanged: (value) {
                                context.read<EditDishBloc>().add(
                                    EditDishIngredientEvent(ingredient: value));
                              },
                              title: "Ingredient",
                              hint: "Add Ingredient",
                              icon: Icons.kitchen),
